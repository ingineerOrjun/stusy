...
| Internal links | 1,502, all resolving |
...
| Written content | 54,036 words |
| Hand-drawn SVG diagrams | 55 (44 static, 11 animated) |
| Worked examples | 51 |
| Exam-style questions | 65, each with a model answer |
| Interactive components | 26 simulations, 21 runtime modules + 6 services |
| Traceable C++ programs | 3 (58 steps) |
| Question bank | 121, tagged by unit, topic and difficulty |
| Prediction exercises | 18, commit-before-reveal |
| Automated tests | 290 |
...
content-contract violation) followed by `npm test` (290 tests covering the build,
...
tests/                     290 automated tests (npm test)
...
Thirty-seven documents, indexed by what you are trying to do:
